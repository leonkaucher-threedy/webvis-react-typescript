...
export function registerWebvisContextReadyListener(listener: WebvisContextReadyListener) {
...
export function unregisterWebvisContextReadyListener(listener: WebvisContextReadyListener) {
